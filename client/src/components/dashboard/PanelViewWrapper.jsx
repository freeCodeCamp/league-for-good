...
class PanelViewWrapper extends Component {
	...
	render() {
		...
		switch (this.props.view) {
			...
			case 'EditActiveTeam':
				return <TeamTable action="edit" teams={league.active_teams} title="Active Teams"/>;
			case 'EditArchivedTeam':
				return <TeamTable action="edit" teams={league.archived_teams} title="Archived Teams"/>;
			case 'DeleteTeam':
				return (
					<TeamTable 
						action="delete"
